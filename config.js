...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const spinner=document.createElement('script');spinner.src='./spinner-engine.js?v=2';document.body.appendChild(spinner);
  const solo=document.createElement('script');solo.src='./solo-mode.js?v=5';document.body.appendChild(solo);
  const scoring=document.createElement('script');scoring.src='./scoring-engine.js?v=4';document.body.appendChild(scoring);
  const strict=document.createElement('script');strict.src='./strict-rules.js?v=3';document.body.appendChild(strict);
